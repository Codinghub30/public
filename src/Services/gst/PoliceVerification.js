...
import "../gst/policeverification.css"
...
const PoliceVerification = () => {
 ...
 const openPopup = () => {
        setShowPopup(true);
        navigate("/policeverification-form"); // Update the URL
      };
    
      // Function to close the popup and revert the URL
      const closePopup = () => {
        setShowPopup(false);
        navigate("/policeverification"); // Revert the URL
        setCurrentStep(1);
      ...
      React.useEffect(() => {
        ...
        if (location.pathname === "/policeverification-form" || location.pathname === "/policeverification/proceed-to-pay") {
          setShowPopup(true);
        } else {
          setShowPopup(false);
        }
 ...
 const [isLoading, setIsLoading] = useState(false);
  ...
  const submitDataToAPI = async () => {
    const data = {
      ...
      comment: "",
      status: "",
      service: "Police Verification Certificate",
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        if (response.data.status === "success") {
          ...
          finishSubmission();
          navigate("/policeverification/proceed-to-pay");
...
<meta content="ALL" name="WEBCRAWLERS"/>
      ...
      >
        <div className="row justify-content-center">
          ...
          <div className="col-12 col-md-8 position-relative d-none d-lg-block">
            ...
            {/* Third Section */}
            <div className="text-center mb-5" style={{marginTop:'-26%'}}>
              <div style={{ position: "relative" }}>
                <img
                  src={circleIcon}
                  alt="Circle Background"
        ...
        <div className="d-none d-lg-block">
          ...
          >
            ...
            >
              ...
              <li style={{ fontWeight: "" }}>Passport size photo</li>
            </ul>
          </div>
  ...
  <div className="address-proof-section row-container ">
    ...
    <div className="content-container">
      ...
      <ul className="document-list" style={{ listStyleType: "disc",}}>
        <li style={{ fontSize: '14px' }}>Aadhaar card</li>
  ...
  <button className="continue-button" onClick={openPopup} style={{borderRadius:'0px'}}>
    Continue
        ...
        {showPopup && (
          <div
             className="popupstyle-verification"
            style={{
              position: "fixed",
              top: "100px",
              left: "0",
          ...
          >
            ...
            >
              ...
              {!isCompleted ? (
                <> 
                  <div className="stepper-verification"
                    style={{
                      display: "flex",
                      justifyContent: "space-between",
                      marginBottom: "30px",
                  ...
                  >
                    {Array.from({ length: 3 }).map((_, index) => (
                      <React.Fragment key={index}>
                        ...
                        >
                          <button className="button-verification-stepper"
                        ...
                        >
                          <label
                            style={{
                              ...
                              maxWidth: "500px", // Restrict label width for better alignment
                              textAlign: "left",
                            }}
                          >
                            <input
                              ...
                              value=" Police verification certificate for job"
                              onChange={handleApplyingFor}
                              style={{textAlign:'left'}}
                            />
                            Police verification certificate for job
                          </label>
                          <label
                            style={{
                              display: "flex",
                          ...
                          >
                            <input
                              type="radio"
                              name="agreementOption"
                              value="Police Verification Certificate PVC - Coolie/Loader/Class IV security
        staff/supervisor at Airport"
                              onChange={handleApplyingFor}
                              style={{textAlign:'left'}}
                            />
                            Police Verification Certificate PVC -
                            Coolie/Loader/Class IV security staff/supervisor at
                            Airport
                          </label>
                          <label
                            style={{
                          ...
                          >
                            <input
                              type="radio"
                              name="agreementOption"
                              value="Police Verification Certificate for central/state Government Employees
        request directly by employee Antecedents Verification"
                              onChange={handleApplyingFor}
                              style={{textAlign:'left'}}
                            />
                            Police Verification Certificate for central/state
                            Government Employees request directly by employee
...
{currentStep === 2 && (
  ...
  >
    Verify
                    ...
                    <>
                 {location.pathname === "/policeverification/proceed-to-pay" && (
  ...
  <div style={{ display: "flex", flexWrap: "wrap", gap: "10px" }}>
    {[
      ...
      { label: "Services", value: applyingFor || "N/A" },
    ].map((item, index) => (
