...
const [isLoading, setIsLoading] = useState(false);
  ...
  const [showOtpSection, setShowOtpSection] = useState(true);
   const openPopup = () => {
     ...
     React.useEffect(() => {
       ...
       if (location.pathname === "/senior-citizen-card-form" || location.pathname === "/senior-citizen-card/proceed-to-pay") {
         setShowPopup(true);
       } else {
         setShowPopup(false);
       }
  ...
  const handleProceedToPay = async () => {
    ...
    try {
        const response = await axios.post(
            "http://localhost:9000/api/PG/paytm/initiate",
            requestBody
        );
...
<meta content="ALL" name="WEBCRAWLERS"/>
    ...
    <div style={{overflow:'hidden'}}>
      <div className="container-senior"
        // style={{
      ...
      >
        <div style={{ flex: 1, textAlign: "left", fontWeight: "bold" }} className="senior-textcontent">
          <p>"Expert Assistance for Quick and Convenient Senior <br className="d-block d-lg-none"/>
          Citizen Card Services - Apply Now!</p>
        </div>
        <div>
          <img 
            src={Image30}
      ...
      <div className="senior-text-container">
        <h2 style={{ color: "#1A76D8", fontWeight: "600", marginLeft: "20px" }}>
          Note!
        </h2>
        ...
        <div className="d-none d-lg-block">
          ...
          <div style={{ marginLeft: "72%", marginTop: "35%" }}>
            ...
            >
              ...
              <li style={{ fontWeight: "" }}>
                If you decide to cancel your order after payment, <br/>please note
      ...
      <div className="senior-card-container d-block d-lg-none" style={{ marginTop: '-18%' }}>
  {/* Documents Section */}
  <div className="senior-card-section documents-section row-container">
    ...
    <div className="content-container">
      <h4 className="section-title" style={{ textAlign: 'left' }}>Documents Required For Senior <br/> Citizen Card</h4>
    ...
    <div className="content-container">
      ...
      <ul className="document-list" style={{ listStyleType: "disc",}}>
        ...
        <li>
          ...
          cancellation fee of <span className="bold-text">Rs. 50</span> will apply.
        </li>
      </ul>
    </div>
  </div>
...
<div className="continue-button-container">
            ...
            >
              ...
              {!isCompleted ? (
                <>
                  ...
                  >
                    {Array.from({ length: 3 }).map((_, index) => (
                      <React.Fragment key={index}>
                        ...
                        >
                          <button className="button-senior-stepper"
                  ...
                  {currentStep === 1 && (
                    <div className="application-step" style={{ textAlign: "center" }}>
  <h4 className="application-heading" style={{ color: "#1A76D8", fontWeight: "600" }}>
    Application
  </h4>
  <div
    className="form-row"
  ...
  >
    {/* First Column */}
    <div className="form-column" style={{ flex: 1, marginRight: "10px", textAlign: "left" }}>
      {/* Name Input */}
    ...
    {/* Second Column */}
    <div className="form-column" style={{ flex: 1, textAlign: "left" }}>
      {/* Date of Birth */}
      <div className="form-group" style={{ marginBottom: "20px" }}>
        <label
          className="form-label"
  ...
  <br />
      ...
      <input
        ...
        style={{
          ...
          padding: "10px",
          fontSize: "16px",
          border: `2px solid ${errors.pincode ? "red" : "#FCA505"}`, // Red border if error
          borderRadius: "10px",
        }}
      />
      {errors.pincode && (
  ...
  <>
    ...
    <div style={styles.infoBox}>
      <div style={styles.inputGroup}>
        ...
        <input type="text" value={userDetails?.name || "N/A"} readOnly style={styles.input} />
      </div>
      <div style={styles.inputGroup}>
        <label style={styles.label}>Mobile Number:</label>
        <input type="text" value={userDetails?.mobilenumber || "N/A"} readOnly style={styles.input} />
      </div>
      <div style={styles.inputGroup}>
        <label style={styles.label}>Order ID:</label>
        <input type="text" value={userDetails?.orderid} readOnly style={styles.input} />
      </div>
      <div style={styles.inputGroup}>
        <label style={styles.label}>Services:</label>
        <input type="text" value="SeniorCitizen" readOnly style={styles.input} />
      </div>
      <div style={styles.inputGroup}>
        <label style={styles.label}>Payment Amount:</label>
        <input type="text" value={paidAmount || "₹0"} readOnly style={styles.input} />
      </div>
    </div>
    <div className="proceed-button-container">
      <button onClick={handleProceedToPay} className="proceed-button" style={{ color: '#000', fontWeight: 'bold' }} disabled={isLoading}>
      ...
      >
        ...
        <>
          <p style={{textAlign:'left'}}>
            Welcome to the one-stop destination for all your Senior Citizen Card
            needs. At Make My Senior Citizen Card, we are dedicated to making
            the process of obtaining your Senior Citizen Card as smooth and
            convenient as possible. Here's everything you need to know about the
            Senior Citizen Card and our services:
          </p>

          <p style={{textAlign:'left'}}>
            Senior Citizen Card Benefits: The Senior Citizen Card offers a host
            of benefits, including discounts on various services, priority
            access, healthcare subsidies, and more, enhancing the quality of
          ...
          <p style={{textAlign:'left'}}>
            ...
            for new Senior Citizen Card applications, ensuring you have all the
            necessary documents and information to complete the process
            successfully.
          </p>
          ...
          <p style={{textAlign:'left'}}>
            ...
            Citizen Card scheme, offering different benefits and opportunities.
            We'll guide you through the options available in your area.
          </p>

          <p style={{textAlign:'left'}}>
            Senior Citizen Card Online: We facilitate online application
            processes, ensuring that you can apply for your Senior Citizen Card
            from the comfort of your home.
          </p>

          <p style={{textAlign:'left'}}>
            Senior Citizen Card Documents: Our team will assist you in preparing
            and submitting the necessary documents to support your Senior
          ...
          <p style={{textAlign:'left'}}>
            Senior Citizen ID Card: The Senior Citizen Card is often referred to
            as the Senior Citizen ID card, and we are here to help you obtain
            it.
          </p>

          <p style={{textAlign:'left'}}>
            Senior Citizen Card for Government Benefits: The Senior Citizen Card
            may open doors to various government benefits, and we'll ensure you
            have access to them.
          </p>

          <p style={{textAlign:'left'}}>
            If you're in need of Senior Citizen Card services in Karnataka, your
            journey starts here with Make My Documents. Contact us today to
            learn more about our services and to schedule an appointment with
            one of our experienced agents. We look forward to assisting you in
            obtaining your Senior Citizen Card and unlocking a world of benefits
            and discounts.
          </p>
        </>
      </div>
